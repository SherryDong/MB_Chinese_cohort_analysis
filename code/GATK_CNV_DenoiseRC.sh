...
tumor=result/WES/GATK4/${sample}/${sample}_CNV.pon.hdf5
...
$gatk_path --java-options "$java_mem" DenoiseReadCounts \
  -I $tumor \
  --count-panel-of-normals result/WES/pon/cnv.pon.hdf5 \
  --standardized-copy-ratios  result/WES/GATK4/${sample}/${sample}_CNV.standardizedCR.tsv \
  --denoised-copy-ratios result/WES/GATK4/${sample}/${sample}.denoisedCR.tsv
